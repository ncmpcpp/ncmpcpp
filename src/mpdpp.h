...
struct Connection
{
	...
	bool AddRandomTag(mpd_tag_type, size_t, const std::string &db_exclude_pattern, std::mt19937 &rng);
	bool AddRandomSongs(size_t number, const std::string &random_exclude_pattern, const std::string &db_exclude_pattern, std::mt19937 &rng);
